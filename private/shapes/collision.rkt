...
(rl collision-rect [_fun _Rect _Rect -> _Rect] #:c-id GetCollisionRec)

;;  Check if point is inside rectangle
; bool CheckCollisionPointRec(Vector2 point, Rectangle rec);
(rl pt-rect-colliding? [_fun _Vec2 _Rect -> _bool] #:c-id CheckCollisionPointRec)

;;  Check if point is inside circle
; bool CheckCollisionPointCircle(Vector2 point, Vector2 center, float radius);
(rl pt-circ-colliding? [_fun _Vec2 _Vec2 _float -> _bool] #:c-id CheckCollisionPointCircle)

;;  Check if point is inside a triangle
; bool CheckCollisionPointTriangle(Vector2 point, Vector2 p1, Vector2 p2, Vector2 p3);
(rl pt-tri-colliding? [_fun _Vec2 _Vec2 _Vec2 -> _bool] #:c-id CheckCollisionPointTriangle)
