...
; int GetMouseX(void);
(rl mouse-x [_fun -> _int] #:c-id GetMouseX)

;;  Returns mouse position Y
; int GetMouseY(void);
(rl mouse-y [_fun -> _int] #:c-id GetMouseY)

;;  Returns mouse position XY
; Vector2 GetMousePosition(void);
(rl mouse-position [_fun -> _Vec2] #:c-id GetMousePosition)
...
(rl mouse-wheel-move [_fun -> _int] #:c-id GetMouseWheelMove)
