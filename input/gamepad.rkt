...
(rl get-gamepad-name [_fun _GamepadNumber -> _string] #:c-id GetGamepadName)
...
(rl get-gamepad-btn-pressed [_fun -> _GamepadButton] #:c-id GetGamepadButtonPressed)

;;  Return gamepad axis count for a gamepad
; int GetGamepadAxisCount(int gamepad);
(rl get-gamepad-axis-count [_fun _GamepadNumber -> _int] #:c-id GetGamepadAxisCount)

;;  Return axis movement value for a gamepad axis
; float GetGamepadAxisMovement(int gamepad int axis);
(rl get-gamepad-axis-movement [_fun _GamepadNumber _GamepadAxis -> _float] #:c-id GetGamepadAxisMovement)
