...
(rl get-ext [_fun _string -> _string] #:c-id GetExtension)

;;  Get pointer to filename for a path string
; const char *GetFileName(const char *filePath);
(rl get-filename [_fun _string -> _string] #:c-id GetFileName)

;;  Get filename string without extension (uses static string)
; const char *GetFileNameWithoutExt(const char *filePath);
(rl get-filename-w/o-ext [_fun _string -> _string] #:c-id GetFileNameWithoutExt)

;;  Get full path for a given fileName with path (uses static string)
; const char *GetDirectoryPath(const char *filePath);
(rl get-dir-path [_fun _string -> _string] #:c-id GetDirectoryPath)

;;  Get previous directory path for a given path (uses static string)
; const char *GetPrevDirectoryPath(const char *dirPath);
(rl get-prev-dir-path [_fun _string -> _string] #:c-id GetPrevDirectoryPath)

;;  Get current working directory (uses static string)
; const char *GetWorkingDirectory(void);
(rl get-working-dir [_fun -> _string] #:c-id GetWorkingDirectory)
...
(rl get-file-mod-time [_fun _string -> _long] #:c-id GetFileModTime)
