...
(rl get-screen-width [_fun -> _int] #:c-id GetScreenWidth)

;;  Get current screen height
; int GetScreenHeight(void);
(rl get-screen-height [_fun -> _int] #:c-id GetScreenHeight)

;;  Get number of connected monitors
; int GetMonitorCount(void);
(rl get-monitor-count [_fun -> _int] #:c-id GetMonitorCount)

;;  Get primary monitor width
; int GetMonitorWidth(int monitor);
(rl get-monitor-width [_fun _int -> _int] #:c-id GetMonitorWidth)

;;  Get primary monitor height
; int GetMonitorHeight(int monitor);
(rl get-monitor-height [_fun _int -> _int] #:c-id GetMonitorHeight)

;;  Get primary monitor physical width in millimetres
; int GetMonitorPhysicalWidth(int monitor);
(rl get-monitor-physical-width [_fun _int -> _int] #:c-id GetMonitorPhysicalWidth)

;;  Get primary monitor physical height in millimetres
; int GetMonitorPhysicalHeight(int monitor);
(rl get-monitor-physical-height [_fun _int -> _int] #:c-id GetMonitorPhysicalHeight)
...
(rl get-monitor-name [_fun _int -> _string] #:c-id GetMonitorName)

;;  Get clipboard text content
; const char *GetClipboardText(void);
(rl get-clipboard-text [_fun -> _string] #:c-id GetClipboardText)
